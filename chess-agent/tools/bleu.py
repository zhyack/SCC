...
def corpus_bleu(hypothesis, references, max_n=4):
    ...
    bleu = brevity_penalty*math.exp(log_bleu / 4.0)
    # refer to https://github.com/harsh19/ChessCommentaryGeneration/blob/master/Code/methods/category_aware/BLEU2.perl
