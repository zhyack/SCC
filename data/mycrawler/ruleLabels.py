...
for line in codecs.open("data/rules.txt", 'r', 'UTF-8'):
    words=line[:-1].split(",")
...
if __name__=="__main__":
    ...
    outFile=codecs.open(sys.argv[1]+".pseudoLabels","w", 'UTF-8')
    print("outfile = ",outFile)

    for indexedLine in indexedLines:
        outFile.write(str(indexedLine[1]).replace('|', '')+" |||| "+str(indexedLine[2])+"\n")
